# Penalty-Scan - N3x4, 41x41 pts, airy, 2026-08-31
...
```
width/MHz = 0.19571 · waist/µm + 0.0042851
```

- Steigung a = 0.195706 MHz/µm
- Achsenabschnitt b = 0.00428507 MHz
- R² = 0.9934
- gefitteter Bereich: 1.0333 .. 1.6727 µm
- verwendete Talpunkte: 23 von 41
- ausgeschlossen: 11 mit Minimum am Rand des gescannten Fensters, 7 auf einem abgesetzten Nebenzweig bzw. als Rand-Kink
