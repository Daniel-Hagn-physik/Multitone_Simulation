# Penalty-Scan - N3x4, 21x21 pts, airy, 2026-08-28
...
```
width/MHz = 0.27786 · waist/µm + 0.012834
```

- Steigung a = 0.277856 MHz/µm
- Achsenabschnitt b = 0.0128345 MHz
- R² = 0.9864
- gefitteter Bereich: 0.7872 .. 1.0333 µm
- verwendete Talpunkte: 10 von 21
- ausgeschlossen: 6 mit Minimum am Rand des gescannten Fensters, 5 auf einem abgesetzten Nebenzweig bzw. als Rand-Kink
