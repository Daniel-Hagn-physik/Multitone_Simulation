...
Alle drei Dateien tragen denselben Präfix
(`AmpFit_N3x4_10x10pts_Airy_weighted_korrigiert_2026-08-21`), damit sie
eindeutig als zusammengehöriger Satz erkennbar sind:

- `AmpFit_N3x4_10x10pts_Airy_weighted_korrigiert_2026-08-21_Formeln.md` — dieses Dokument.
- `Fit_Plots/AmpFit_N3x4_10x10pts_Airy_weighted_korrigiert_2026-08-21_r_x.png` — 5-Panel-
  Diagnose (Rohdaten, Polynom, physikalisches Modell, Spline, Residuen) für r_x.
- `Fit_Plots/AmpFit_N3x4_10x10pts_Airy_weighted_korrigiert_2026-08-21_r_y.png` — dasselbe für r_y.

Namensschema (ab jetzt Standard für alle Fit-Auswertungen in diesem Projekt):
`AmpFit_N{Nx}x{Ny}_{n_win}x{n_width}pts_{Profil}_{weighted|hart}_{roh|korrigiert}_{Datum}`
gefolgt von `_Formeln.md` bzw. `_r_x.png`/`_r_y.png`. Kodiert damit: Tonanzahl,
Gitterauflösung, Strahlprofil, ob gewichtete oder harte Metrik, ob die
Post-hoc-Korrektur angewendet wurde, und das Datum des Laufs.
