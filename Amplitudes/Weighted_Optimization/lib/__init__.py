...
Haupt-Skripten importiert:
    ...
    ../run_all_fits.py   ->  lib.fit_central_amplitudes, lib.fit_waist_width_relation,
                             lib.fit_uniformity_valley_overview
...
- weighted_multitone_flattop_optimizer.py  der eigentliche Optimierer
- weighted_multitone_amplitude_dependence_plots.py  Scan-Plotter
- weighted_amp_scan_methods.py             die gewichteten Scan-Methoden
- fit_central_amplitudes.py, fit_waist_width_relation.py,
  fit_uniformity_valley_overview.py        die drei Fits von run_all_fits.py
