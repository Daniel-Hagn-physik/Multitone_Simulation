...
class FlatMultiToneWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # height_ratios: die Nachbar-2D-Abbildung (Zeile 0) bleibt groß wie ein
    ...
    def redraw_rectangles(self):
        ...
        # dem Fadenkreuz (zorder=7), statt dass die Fadenkreuz-Linien optisch in
        # die Legende hineinragen.
    ...
    def full_update(self):
        ...
        # Eigenes, festes Zoom-Fenster für die Nachbar-Ansicht, damit alle acht
        # pitch-verschobenen Kopien vollständig sichtbar sind (siehe Docstring
        # von configure_neighbor_view).
        configure_neighbor_view(self.ax_neighbor, r_center * 1e6, pitch * 1e6)
    ...
    def on_save(self):
        ...
        # Wie bei der interaktiven Ansicht: automatisches Layout-Management,
        # sonst überlappen sich bei den (jetzt größeren) Schriftgrößen und den
        # verkleinerten Schnittplot-Zeilen schnell Titel/Achsenbeschriftungen.
        ...
        fig_save.suptitle(
            ...
            fontsize=EXPORT_FONTSIZE_SUPTITLE, fontweight="bold"
        )

        # Gleiche Struktur wie im interaktiven Fenster: Hauptplot über die volle
        # Höhe, Nachbar-Plot (Zeile 0) groß wie ein "richtiger" 2D-Plot, die
        # beiden Schnittplots (Zeile 1/2) bewusst kleiner.
        ...
        # Auch im Export: Nachbar-Achse auf ein festes Fenster um das Zentrum
        # zoomen, damit alle acht Kopien vollständig sichtbar sind.
